...
class classifier:
    ...
    def configureNeuralNetwork(self, numberOfInputs, numberOfClasses, numberOfHiddenNeurons = 5,
        ...
        self.layers = [numberOfInputs] + numberOfHiddenNeurons + [numberOfClasses] # rewrite this as a numpy array
    ...
    # This function calculates the cost function and backpropagates the erros
